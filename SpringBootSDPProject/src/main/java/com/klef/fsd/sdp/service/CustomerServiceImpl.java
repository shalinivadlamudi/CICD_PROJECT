...
//	}
	@Override
	public String bookevent(BookEvent bookEvent) {
	    // Ensure we attach real entities from DB
	    Customer customer = customerRepository.findById(bookEvent.getCustomer().getId())
	            .orElseThrow(() -> new RuntimeException("Customer not found"));
	    Event event = eventRepository.findById(bookEvent.getEvent().getId())
